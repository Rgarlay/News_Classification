...
def SaveToken( token, path_to_save, token_name):
    try:
        file_path = os.path.join(path_to_save,token_name)
...
def train_model(model, X_train, X_test, y_train, y_test, epochs=None, batch_size=None):
